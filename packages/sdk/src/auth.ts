/**
 * Authentication utilities for otel-bun CLI
 */
...
import { WorkOSTokenResponseSchema } from "@otel-bun/types";
import { z } from "zod";
...
/**
 * Loads authentication data from ~/.local/share/otel-bun/auth.json
