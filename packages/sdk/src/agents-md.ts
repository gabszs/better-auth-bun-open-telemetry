...
function generateReferencesTable(_references: InstalledReference[]): string {
	const lines = [
		"## Project References",
		"",
		"Use the otel-bun CLI to find and read directly from local codebases for any repo in `.otel-bun/map.json` whenever the user asks about a specific open source project.",
		"",
	];
