 ...
 * A reference is considered installed if {owner-repo}.md exists in otel-bun/references/.
 *
 ...
 *
 * Status logic:
 * - installed: {owner-repo}.md exists in otel-bun/references/
 * - remote: Reference exists on otel-bun.sh (quick pull)
 ...
 */
export function matchDependenciesToReferences(
