...
Convex serverless backend for otel-bun.

Stores and serves shared references from the community at [otel-bun.sh](https://otel-bun.sh).
...
```typescript
import { api } from "@otel-bun/backend/api";
